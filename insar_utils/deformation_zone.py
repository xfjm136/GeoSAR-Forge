    ...
    *,
    ...
    summary = {
        ...
        "region_score_terms": {
            ...
            "min_area_fraction": float(retention_summary["min_area_fraction"]),
            "min_support_points": int(retention_summary["min_support_points"]),
            "salient_min_points": int(retention_summary["salient_min_points"]),
            "min_internal_trace_corr": float(retention_summary["min_internal_trace_corr"]),
            "min_temporal_coherence": float(retention_summary["min_temporal_coherence"]),
            "min_compactness": float(retention_summary["min_compactness"]),
            "min_region_score": float(retention_summary["min_region_score"]),
            "salient_region_score": float(retention_summary["salient_region_score"]),
            "salient_temporal_coherence": float(retention_summary["salient_temporal_coherence"]),
            "salient_boundary_contrast": float(retention_summary["salient_boundary_contrast"]),
            "salient_activity_threshold": float(retention_summary["salient_activity_threshold"]),
        },
